...
#def generate_neg_class_decvals(num):
#    return [random.normalvariate(0.0, 1.0) for _ in range(num)]
##    return [random.normalvariate(0.0, 2.5) for _ in range(num)]
#
#def generate_pos_class_decvals(num, d=d):
#    return [random.normalvariate(d, 0.3) for _ in range(num)]
...
#labels, true_labels, decision_values = load_resvm_data('experiments/sensit_1_0.pkl', 'sup', 0.2, 0.2)
#labels, true_labels, decision_values = load_resvm_data('experiments/sensit_1_0.pkl', 'semi', 0.1, 0.1)
...
#print('guessed pfrac: ' + str(guessed_pfrac))
#print('num unlabeled: ' + str(labels.count(None)))
#print('num pos: ' + str(labels.count(True)))
